...
const CreateCardSchema = z.object({
  ...
  workspacePath: z.string().trim().max(500).optional().nullable(),
  workspaceKind: z.enum(['dir', 'worktree', 'scratch']).optional().nullable(),
  modelOverride: z.string().trim().max(120).optional().nullable(),
  reasoningEffort: z.string().trim().max(120).optional().nullable(),
})
