...
import { armWarRoomAgentsManually, getAgentConnectionStoreInfo } from '../../../../lib/war-room/body'
...
export const Route = createFileRoute('/api/war-room/agent-control/arm')({
  server: {
    handlers: {
      POST: async ({ request }) => {
        ...
        const state = armWarRoomAgentsManually({
