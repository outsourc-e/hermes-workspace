...
import { freezeWarRoomAgents, getAgentConnectionStoreInfo } from '../../../../lib/war-room/body'
...
export const Route = createFileRoute('/api/war-room/agent-control/freeze')({
  server: {
    handlers: {
      POST: async ({ request }) => {
        ...
        const state = freezeWarRoomAgents({
