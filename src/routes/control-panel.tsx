...
import { ControlPanelScreen } from '@/screens/control-panel/control-panel-screen'

export const Route = createFileRoute('/control-panel')({
  ssr: false,
  component: function ControlPanelRoute() {
    usePageTitle('Control Panel')
    return <ControlPanelScreen />
  },
  errorComponent: function ControlPanelError({ error }) {
    return (
  ...
  pendingComponent: function ControlPanelPending() {
    return (
      <div className="flex h-full items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-primary-500">Loading Control Panel...</p>
        </div>
      </div>
    )
  },
