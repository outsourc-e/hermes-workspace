        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            d.innerHTML = '<img src="/hermes-avatar.webp" alt="Hermes" style="width:80px;height:80px;margin-bottom:20px;border-radius:16px;filter:drop-shadow(0 8px 32px color-mix(in srgb,'+accent+' 45%, transparent))" />'
              + '<img src="/hermes-banner.png" alt="HERMES-AGENT" style="width:280px;height:auto;margin-bottom:8px;'+(isDark ? 'filter:drop-shadow(0 4px 16px rgba(0,0,0,0.5))' : 'filter:invert(1) drop-shadow(0 4px 16px rgba(0,0,0,0.15))')+'" />'
