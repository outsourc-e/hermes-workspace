          ...
          >
            <div className="mb-2 flex items-center justify-between gap-2 text-[10px] font-semibold uppercase tracking-[0.14em] text-[var(--theme-muted)]">
              ...
              <div className="min-w-0 flex-1 text-center">
                ...
                @typescript-eslint/no-unnecessary-condition -- runtime safety:
                optional chain protects against nullable field not visible to TS
                // eslint-disable-next-line
                @typescript-eslint/no-unnecessary-condition -- runtime safety:
                TS narrows incorrectly, the LHS can be null/undefined at runtime
                ...
                <div className="truncate text-[10px] font-medium normal-case tracking-normal text-[var(--theme-muted)]/80">
                  // eslint-disable-next-line
                  @typescript-eslint/no-unnecessary-condition -- runtime safety:
                  optional chain protects against nullable field not visible to
                  TS // eslint-disable-next-line
                  @typescript-eslint/no-unnecessary-condition -- runtime safety:
                  TS narrows incorrectly, the LHS can be null/undefined at
                  runtime
            ...
            <p className="mb-2 mx-auto max-w-2xl text-center text-[11px] leading-relaxed text-[var(--theme-muted)]">
              ...
              optional chain protects against nullable field not visible to TS
              // eslint-disable-next-line
              @typescript-eslint/no-unnecessary-condition -- runtime safety: TS
              narrows incorrectly, the LHS can be null/undefined at runtime
