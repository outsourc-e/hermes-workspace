          ...
          <div className="space-y-6">
            ...
            <section className="grid gap-3 sm:grid-cols-3">
              <div className="rounded-2xl border border-[var(--theme-border)] bg-[var(--theme-card)] px-4 py-3">
                <p className="text-[10px] font-semibold uppercase tracking-[0.18em] text-[var(--theme-muted)]">
                  Execution queue
                </p>
              ...
              <div className="rounded-2xl border border-[var(--theme-border)] bg-[var(--theme-card)] px-4 py-3">
                ...
                <p
                  className="mt-1 truncate text-sm font-medium text-[var(--theme-text)]"
                  title={conductor.missionId ?? 'Not available'}
                >
                  {conductor.missionId ?? 'Not available'}
                </p>
              </div>
              <div className="rounded-2xl border border-[var(--theme-border)] bg-[var(--theme-card)] px-4 py-3">
                <p className="text-[10px] font-semibold uppercase tracking-[0.18em] text-[var(--theme-muted)]">
