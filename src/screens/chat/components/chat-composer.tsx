                                  ...
                                  workspaceEntries.map((workspace) => {
                                    ...
                                    return (
                                      ...
                                      >
                                        ...
                                        <span className="mt-0.5 truncate text-[11px] text-neutral-500">{workspace.path}</span>
                                      </button>
                                    )
                                  })
                                ) : (
                                  <div className="px-3 py-2 text-xs text-neutral-500">No workspaces detected</div>
                                )}
                                <button
                                  type="button"
