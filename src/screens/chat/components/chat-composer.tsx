                              ...
                              <div className="absolute bottom-full left-0 z-[200] mb-2 min-w-[14rem] overflow-hidden rounded-xl border border-neutral-200 bg-white p-1 shadow-xl animate-in fade-in slide-in-from-bottom-2 duration-150 dark:border-neutral-700 dark:bg-neutral-900">
                                ...
                                {workspaceEntries.map((workspace) => {
                                  ...
                                  return (
                                    ...
                                    >
                                      <span className="flex items-center gap-2">
                                        <span className="truncate font-medium">{workspace.name || workspace.path}</span>
                                        {selected ? <span className="text-[10px] text-accent-500">active</span> : null}
                                      </span>
                                      {workspace.path ? <span className="mt-0.5 max-w-[12rem] truncate text-[11px] text-neutral-500">{workspace.path}</span> : null}
                                    </button>
                                  )
                                })}
                                ...
                                <button
                                  ...
                                  className="mt-1 flex w-full items-center gap-2 border-t border-neutral-100 px-3 py-2 text-left text-xs text-primary-600 transition-colors hover:bg-neutral-50 dark:border-neutral-800 dark:hover:bg-neutral-800/60"
                                >
