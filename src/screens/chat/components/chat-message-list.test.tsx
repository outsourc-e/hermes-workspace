...
describe('buildDisplayEntries', () => {
  it('attaches trailing persisted tool-only assistant messages to the last text reply', () => {
    // Post-#543 behavior: trailing tool-only assistant messages are attached
    // to the final text reply so their activity renders under it, instead of
    ...
    expect(entries[1].attachedToolMessages).toHaveLength(2)
  })
})
