  ...
  return (
    ...
    >
      ...
      <div className="grid min-h-0 flex-1 grid-cols-1 gap-3 p-3 md:grid-cols-3 md:p-4">
        ...
        <section className="min-h-0 rounded-2xl border border-primary-200 bg-primary-50 md:col-span-2">
                ...
                {isEditing ? (
                  <>
                    ...
                    <button
                      ...
                      className="rounded-md border border-primary-200 px-3 py-1.5 text-xs font-semibold transition-colors hover:border-primary-300 hover:bg-primary-200 disabled:cursor-not-allowed disabled:opacity-50"
                    >
                      Cancel
                    </button>
                    {hasUnsavedChanges ? (
                  ...
                  <button
                    ...
                    className="relative inline-flex items-center gap-1.5 rounded-md border border-primary-200 px-3 py-1.5 text-xs font-semibold transition-colors hover:border-primary-300 hover:bg-primary-200"
                  >
                    <HugeiconsIcon
