                ...
                {isEditing ? (
                  <>
                    <button
                      ...
                      className="rounded-md bg-[var(--theme-accent)] px-3 py-1.5 text-xs font-semibold text-black shadow-sm transition-colors hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-50"
                    >
