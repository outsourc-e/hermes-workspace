...
const baseSections: Array<TemplateSection> = [
  {
    id: 'promise',
    title: 'Positionnement en 30 secondes',
    purpose: 'Dire quoi vendre, a qui, avec quel angle et sans promesse non sourcée.',
    required: true,
  },
  {
    id: 'target',
    title: 'Pour qui ?',
    purpose: 'Décrire les segments clients ou partenaires pertinents et les cas a exclure.',
    required: true,
  },
  {
    id: 'problems',
    title: 'Signaux d’achat',
    purpose: 'Lister les signaux concrets qui justifient de proposer l’offre.',
    required: true,
  },
  {
    id: 'benefits',
    title: 'Pourquoi le vendre ?',
    purpose: 'Mettre en avant les bénéfices commerciaux, client et partenaire.',
    required: true,
  },
  {
    id: 'offer',
    title: 'Socle offre',
    purpose: 'Présenter le forfait, les inclus, exclusions, engagements, pre-requis et variantes.',
    required: true,
  },
  {
    id: 'pricing',
    title: 'Grille tarifaire et conditions',
    purpose: 'Indiquer prix HT/mois, engagement, canal, date, source et statut de validation.',
    required: true,
  },
  {
    id: 'options',
    title: 'Options et upsell',
    purpose: 'Lister les options incluses, activables, sur devis ou soumises a compatibilite.',
    required: true,
  },
  {
    id: 'qualification',
    title: 'À vérifier avant devis',
    purpose: 'Donner les questions de qualification et points bloquants avant chiffrage.',
    required: true,
  },
  {
    id: 'objections',
    title: 'Objections et réponses',
    purpose: 'Préparer les réponses commerciales et les limites a ne pas promettre.',
    required: true,
  },
  {
    id: 'conditions',
    title: 'Conditions et garde-fous',
    purpose: 'Cadrer couverture, activation, roaming, portabilite, hors forfait, support et responsabilites.',
    required: true,
  },
  {
    id: 'sources',
    title: 'Sources, version et limites',
    purpose: 'Citer les documents, dates, versions, hypotheses et points non confirmes.',
    required: true,
  },
]
...
function rulesFor(channel: TemplateChannel): Array<TemplateQualityRule> {
  return [
    ...
    {
      id: 'do-not-promise',
      label: 'Lister explicitement les points à ne pas promettre avant devis.',
      severity: 'warning',
    },
    {
      id: 'pricing-version',
      label: 'Chaque prix affiché doit préciser HT/mois, engagement, canal, date et source.',
      severity: 'blocking',
    },
  ]
}
