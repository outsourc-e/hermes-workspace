...
describe('computeJobsStat', () => {
  it('counts successes and failures across last 24h', () => {
    ...
    const fixture = {
      jobs: [
        { id: 'a', last_run_at: new Date(now - 3600_000).toISOString(), last_status: 'ok', enabled: true },
        { id: 'b', last_run_at: new Date(now - 7200_000).toISOString(), last_status: 'error', enabled: true },
        { id: 'c', last_run_at: new Date(now - 90_000_000).toISOString(), last_status: 'ok', enabled: true },
