...
describe('deriveCalendarData', () => {
  ...
  it('picks soonest future event as upNext', () => {
    const events = [
      { id: 'a', summary: 'Past', start: '2026-05-26T02:00:00Z', end: '2026-05-26T03:00:00Z' },
      { id: 'b', summary: 'Soon', start: '2026-05-26T04:00:00Z', end: '2026-05-26T05:00:00Z' },
      { id: 'c', summary: 'Later', start: '2026-05-26T08:00:00Z', end: '2026-05-26T09:00:00Z' },
    ];
  ...
  it('marks events <60min away as urgent', () => {
    const events = [
      { id: 'a', summary: 'Imminent', start: '2026-05-26T04:00:00Z', end: '2026-05-26T05:00:00Z' },  // 30min away
      { id: 'b', summary: 'Later', start: '2026-05-26T08:00:00Z', end: '2026-05-26T09:00:00Z' },
    ];
    const cd = deriveCalendarData(events, t0);
  ...
  it('categorises events from calendar name', () => {
    const events = [
      { id: 'a', summary: 'Lab', start: '2026-05-26T05:00:00Z', end: '2026-05-26T06:00:00Z', calendarName: 'uni lectures' },
      { id: 'b', summary: 'Patient', start: '2026-05-26T07:00:00Z', end: '2026-05-26T08:00:00Z', calendarName: 'tadc clinic' },
    ];
    const cd = deriveCalendarData(events, t0);
