...
export const WAR_ROOM_STATION_MANIFESTS: Array<StationToolManifest> = [
  {
    ...
    purpose: 'Natural conversation surface for creating and continuing work with Hermes.',
  ...
  },
  {
    ...
    purpose: 'Operational task, agent, routing, approval, artifact, and readback surface.',
    inputKinds: ['task', 'message', 'evidence', 'cost'],
    outputKinds: ['packet', 'alert', 'approval_request', 'local_decision'],
    allowedIntents: ['move_to_station', 'work_at_station', 'carry_packet', 'request_approval', 'raise_alert'],
    lockedActions: LIVE_LOCKED_ACTIONS,
    approvalRequired: false,
    defaultAgentId: 'hermes',
    cockpitType: 'command',
