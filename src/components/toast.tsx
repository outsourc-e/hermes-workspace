        ...
        {toasts.map(t => (
          <div
            ...
            className={`flex items-center gap-2 rounded-lg border px-4 py-3 text-sm shadow-lg backdrop-blur ${
              t.type === 'success' ? 'border-emerald-500/50 bg-emerald-950/80 text-emerald-400' :
              t.type === 'error'   ? 'border-red-500/50 bg-red-950/80 text-red-400' :
              t.type === 'warning' ? 'border-amber-500/50 bg-amber-950/80 text-amber-400' :
