...
export const ONBOARDING_STEPS: Array<OnboardingStep> = [
  {
    id: 'welcome',
    title: 'Welcome to Nova Mission Control',
    description: 'Your AI workspace powered by Nova gateway',
    icon: Home01Icon,
  ...
  },
  {
    ...
    description: 'Verify that Nova gateway is running before you begin.',
    icon: Plug01Icon,
