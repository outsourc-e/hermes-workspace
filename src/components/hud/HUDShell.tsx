    ...
    <div className="min-h-screen bg-[#0a0e14] text-[#c9d1d9] font-mono p-3">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[2.2fr_1fr] gap-3">
        <div className="flex flex-col gap-2.5">
          <section role="region" aria-label="brief" className="bg-gradient-to-br from-[#1a1f2e] to-[#0d1117] border border-[#21262d] rounded-lg p-3">{brief}</section>
          <section role="region" aria-label="bento">{bento}</section>
          <section role="region" aria-label="timeline" className="bg-[#0d1117] border border-[#21262d] rounded-lg p-3">{timeline}</section>
