...
function ocParseContextPct(payload: unknown): number {
  ...
  return ocReadPercent(
    (usage.contextPercent as number | string | undefined) ??
      (usage.context_percent as number | string | undefined) ??
      (usage.context as number | string | undefined) ??
      (root.contextPercent as number | string | undefined) ??
      (root.context_percent as number | string | undefined),
  )
}
