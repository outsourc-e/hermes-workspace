...
const LANES = {
  ...
  swarm11: ['Reviewer', 'Secondary review lane for high-throughput periods', 'Reviewer lane initialized; ready for parallel review.', '/Users/aurora/claude-workspace'],
  swarm12: ['PR / Issues', 'Backup PR/issues lane for parallel triage', 'PR/issues secondary lane initialized.', '/Users/aurora/claude-workspace'],
